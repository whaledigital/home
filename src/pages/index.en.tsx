...
export const pageQuery = graphql`
  query EnHomeQuery {
    ...
    services: allContentfulService(sort: { fields: order }, filter: { node_locale: { eq: "en" } }) {
      edges {
        node {
          id
          title
    ...
    cases: allContentfulCase(sort: { fields: order }, filter: { node_locale: { eq: "en" } }) {
      edges {
        node {
          id
          title
    ...
    experts: allContentfulExpert(sort: { fields: order }, filter: { node_locale: { eq: "en" } }) {
      edges {
        node {
          id
          title
